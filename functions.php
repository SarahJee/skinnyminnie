 ...
 */
function skinnyminnie_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Skinny Minnie, use a find and replace
	 * to change 'skinnyminnie' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'skinnyminnie', get_template_directory() . '/languages' );
	...
	add_image_size( 'skinnyminnie-index-img', 800, 400, true);
	...
	add_theme_support( 'custom-background', apply_filters( 'skinnyminnie_custom_background_args', array(
...
add_action( 'after_setup_theme', 'skinnyminnie_setup' );
 ...
 */
function skinnyminnie_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'skinnyminnie_content_width', 640 );
}
add_action( 'after_setup_theme', 'skinnyminnie_content_width', 0 );
 ...
 */
function skinnyminnie_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'skinnyminnie' ),
		'id'            => 'sidebar-1',
 ...
 */
function skinnyminnie_scripts() {
	
	//Add Google Fonts
	wp_enqueue_style( 'skinnyminnie-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:400,400i,800" rel="stylesheet' );
	
	wp_enqueue_style( 'skinnyminnie-style', get_stylesheet_uri() );

	wp_enqueue_script( 'skinnyminnie-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), '20151215', true );
